...
public class ConsumerSample {
    ...
    //kafka集群机器
    private static final String KAFKA_HOSTS = "192.168.42.29:9092,192.168.42.29:9093,192.168.42.29:9094";
    //topic名称
    private static final String TOPIC = "topic_001";

    public static void main(String[] args) {
        // TODO Auto-generated method stub
        ConsumerSample consumer = new ConsumerSample();
        //从分区的末尾 或者已存在groupid的请情况下从未消费位置开始消费数据
        consumer.consumerSubscribe("false", TOPIC);
