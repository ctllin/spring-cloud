...
public class RSAUtil {
     ...
     * @throws Exception
     */
    protected String decrypt(String privateKeyStr, byte[] srcBytes) throws Exception {
     ...
     * @throws Exception
     */
    protected String decrypt(String privateKeyStr, String srcStr) throws Exception {
        if (privateKeyStr != null) {
