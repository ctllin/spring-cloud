#include "com_hanshow_wise_base_privileges_lience_HSLienceProvider.h"
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
JNIEXPORT jstring JNICALL Java_com_hanshow_wise_base_privileges_lience_HSLienceProvider_getHspk(JNIEnv *env, jobject jj)
{
...
JNIEXPORT jint JNICALL Java_com_hanshow_wise_base_privileges_lience_HSLienceProvider_getValue(JNIEnv *env, jobject jj, jstring js, jint ji){
